...
class DWAControl:
    def __init__(self):
        ...
        self.max_accel = float(rospy.get_param("~max_accel", 0.30))
        ...
        self.final_speed_min = rospy.get_param("~final_speed_min", 0.18)
        ...
        self.min_forward_cmd = rospy.get_param("~min_forward_cmd", 0.16)
